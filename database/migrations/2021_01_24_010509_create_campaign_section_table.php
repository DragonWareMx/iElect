...
class CreateCampaignSectionTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('campaign_section', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
            $table->enum('prioridad', ['Alta','Media','Baja'])->nullable(); //prioridad de la sección según meta o cliente
            $table->integer('meta')->nullable();                            //meta de la seccion segun el cliente
