...
<div class="uk-margin uk-margin-left uk-margin-right">
            ...
            <div class="uk-padding-small" uk-grid style="display: flex; align-items: center">
                <div>
                    <h3 class="uk-card-title uk-text-bold">
                        <a class="uk-margin-right" href="" uk-icon="arrow-left"></a>Seccion 1272
                    </h3>
                </div>
    ...
    <div class="uk-card uk-card-default uk-padding">
        <div uk-grid>
            ...
            <div class="uk-width-auto uk-width-1-4@m uk-text-left">
                <div class="uk-text-bold">Usuarios agentes</div>
                <div>1.- <a>José Agustín Aguilar Solórzano</a></div>
                <div>2.- <a>Leonardo Daniel López López</a></div>
                <div>3.- <a>Oscar André Huerta García</a></div>
            </div>
        </div>
    </div>

    <!-- Card de Info por Sección -->
