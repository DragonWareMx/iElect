...
<div class="uk-flex uk-flex-middle uk-flex-center uk-animation-fade uk-margin-medium uk-margin-left uk-margin-right uk-margin-remove-bottom" style="border:1px solid #E5E5E5; border-radius: 5px; height: 30rem;">
    <div>
        <div class="uk-padding-small uk-text-center">
            ...
            <a href="javascript:history.back(-1);" class="button uk-margin-top">Regresar</a>
        </div>
    </div>
</div>
