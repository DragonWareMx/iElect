...
<body topmargin="0" rightmargin="0" bottommargin="0" leftmargin="0" marginwidth="0" marginheight="0" width="100%" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; width: 100%; height: 100%; -webkit-font-smoothing: antialiased; text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; line-height: 100%;
	...
	max-width: 560px;" class="container">
			...
			font-family: sans-serif; text-align: justify;" class="paragraph">
                            Hola {{$user->name}}! has sido <strong>aceptado</strong>
                            para convertirte en brigadista de iElect.
                            <strong>Ya puedes ingresar al sistema</strong> con tu correo electrónico y contraseña que utilizaste para el registro.
			...
			color: #000000;
			font-family: sans-serif; text-align: justify;" class="paragraph">
                            Si estás listo para iniciar sesión al sistema iElect
			...
			font-family: sans-serif;text-align: justify;  word-break: break-all;" class="paragraph">
                            ...
                            Si estás teniendo problemas para dar clic al botón de "Iniciar sesion" , copia y pega
                            este enlace URL en tu navegador web: <a
                                href="{{ route('home') }}"
                                target="_blank"
                                style="color: #127DB3; font-family: sans-serif; font-size: 12px; font-weight: 400; line-height: 160%;">{{ route('home') }}</a>
                        </td>
                    </tr>
	...
	max-width: 560px;" class="wrapper">
			...
			font-family: sans-serif;" class="footer">
                            Recibes este correo electrónico porque fuiste aceptado como brigatista en la plataforma web
                            iElect.
